    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title pull-right"> ویرایش محصول {{$brand->name}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form method="post" action="/administrator/brands/{{$brand->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" value="{{$brand->title}}" placeholder="عنوان برند ...">
                            </div>
                            <div class="form-group">
                                <label for="description">توضیحات برند</label>
                                <textarea type="text" name="description" class="form-control" placeholder="توضیحات برند...">{{$brand->description}}</textarea>
                            </div>
                            <div class="form-group">
